...
import { Package, ShoppingBag, LogOut, Menu, X, ChevronRight, BarChart2, Receipt, Building2, FileText, Activity, LifeBuoy, MessageCircle } from 'lucide-react';
...
const AdminLayout = () => {
    ...
    const navItems = [
        ...
        { path: '/admin/faqs',       icon: MessageCircle,   label: 'Product FAQs' },
